...
class CConfig {
 ...
 public:
    ...
    // nanomsg PAIR for strategy <-> server (legacy URL; Kafka uses topics below)
    string BROKERAGE_PAIR_PORT = "tcp://localhost:55558";
    bool cpuaffinity = false;
    /**************** Kafka (when _msgq == MSGQ::KAFKA) ****************/
    string kafka_brokers = "localhost:9092";
    string kafka_topic_server_pub = "sq.server.pub";
    string kafka_topic_engine_commands = "sq.engine.commands";
    string kafka_topic_client_requests = "sq.client.requests";
    string kafka_topic_strategy_to_broker = "sq.strategy.to_broker";
    string kafka_topic_broker_to_strategy = "sq.strategy.from_broker";
    string kafka_group_relay = "sq-relay";
    string kafka_group_prefix = "sq-engine";
    string kafka_group_dataservice = "sq-dataservice-record";
    string kafka_group_strategy = "sq-strategy-md";
    bool kafka_strategy_bridge = true;
    /******************** Message Queue **********/
